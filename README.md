...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/microlink` | `npm install @voxgig-sdk/microlink` |
| Python | `voxgig-sdk-microlink` | `pip install voxgig-sdk-microlink` |
| PHP | `voxgig-sdk/microlink` | `composer require voxgig-sdk/microlink` |
| Golang | `github.com/voxgig-sdk/microlink-sdk/go` | `go get github.com/voxgig-sdk/microlink-sdk/go` |
| Ruby | `voxgig-sdk-microlink` | `gem install voxgig-sdk-microlink` |
| Lua | `voxgig-sdk-microlink` | `luarocks install voxgig-sdk-microlink` |
