...
// Microlink SDK streaming feature
...
class MicrolinkStreamingFeature extends MicrolinkBaseFeature
{
    ...
    private function _iterate(MicrolinkResult $result): \Generator
    {
    ...
    private function _streamable(MicrolinkContext $ctx): bool
    {
