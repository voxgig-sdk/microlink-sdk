...
class MicrolinkCacheFeature extends MicrolinkBaseFeature
{
    ...
    private function _through(MicrolinkContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
