...
class MicrolinkTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = MicrolinkTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = MicrolinkTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = MicrolinkTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
