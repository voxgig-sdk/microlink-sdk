# Microlink SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions MicrolinkSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both MicrolinkSDK(...) and MicrolinkSDK.test(...) become
#      MicrolinkSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "microlink_sdk"
_SDK_CLASS = "MicrolinkSDK"
...
_ENTITIES = {
    "GetWebsiteData": "get_website_data",
}
