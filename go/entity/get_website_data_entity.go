...
import (
	...
	vs "github.com/voxgig-sdk/microlink-sdk/go/utility/struct"
)

type GetWebsiteDataEntity struct {
	name    string
	client  *core.MicrolinkSDK
...
func NewGetWebsiteDataEntity(client *core.MicrolinkSDK, entopts map[string]any) *GetWebsiteDataEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GetWebsiteDataEntity) GetName() string { return e.name }
...
func (e *GetWebsiteDataEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GetWebsiteDataEntity) Deleted() bool {
	return e.deleted
}


func (e *GetWebsiteDataEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGetWebsiteDataEntity(e.client, opts)
}

func (e *GetWebsiteDataEntity) Data(args ...any) any {
...
func (e *GetWebsiteDataEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GetWebsiteData; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GetWebsiteDataEntity) DataTyped(data ...GetWebsiteData) GetWebsiteData {
	if len(data) > 0 {
		return typedFrom[GetWebsiteData](e.Data(asMap(data[0])))
	}
	return typedFrom[GetWebsiteData](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GetWebsiteData (all fields
// optional at the wire level).
func (e *GetWebsiteDataEntity) MatchTyped(match ...GetWebsiteData) GetWebsiteData {
	if len(match) > 0 {
		return typedFrom[GetWebsiteData](e.Match(asMap(match[0])))
	}
	return typedFrom[GetWebsiteData](e.Match())
}
...
func (e *GetWebsiteDataEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GetWebsiteDataEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GetWebsiteDataLoadMatch and returns an GetWebsiteData. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GetWebsiteDataEntity) LoadTyped(reqmatch GetWebsiteDataLoadMatch, ctrl map[string]any) (GetWebsiteData, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return GetWebsiteData{}, err
	}
	return typedFrom[GetWebsiteData](res), nil
}



func (e *GetWebsiteDataEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *GetWebsiteDataEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GetWebsiteDataEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GetWebsiteDataEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GetWebsiteDataEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
