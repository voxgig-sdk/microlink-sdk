...
// Microlink SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class MicrolinkMakeRequest
{
    public static function call(MicrolinkContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new MicrolinkResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new MicrolinkResponse($fetched);
        } else {
