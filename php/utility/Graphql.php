...
class MicrolinkGraphql
{
    ...
    // equivalent.
    public static function body(MicrolinkContext $ctx): mixed
    {
    ...
    public static function errors(MicrolinkContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
