...
from microlink_sdk.utility import register

# Load features
from microlink_sdk.feature.base_feature import MicrolinkBaseFeature
from microlink_sdk.features import _make_feature
...
class MicrolinkSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = MicrolinkUtility()
        self._utility = utility

        from microlink_sdk.config import make_config
        config = make_config()
    ...
    def get_utility(self):
        return MicrolinkUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("MicrolinkSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def GetWebsiteData(self, data=None) -> "GetWebsiteDataEntity":
        ...
        from microlink_sdk.entity.get_website_data_entity import GetWebsiteDataEntity
