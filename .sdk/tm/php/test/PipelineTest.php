...
{
    private static function utility(): MicrolinkUtility
    {
        return new MicrolinkUtility();
    }
    ...
    private static function ctx(array $over = []): MicrolinkContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new MicrolinkContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new MicrolinkOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof MicrolinkError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new MicrolinkOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = MicrolinkMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new MicrolinkOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = MicrolinkMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new MicrolinkOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = MicrolinkMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new MicrolinkSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = MicrolinkMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new MicrolinkResponse([]),
            'result' => new MicrolinkResult([]),
        ]);
        [, $err] = MicrolinkMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new MicrolinkSpec([]),
            'response' => null,
            'result' => new MicrolinkResult([]),
        ]);
        [, $err] = MicrolinkMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new MicrolinkSpec(['step' => 's']),
            'response' => new MicrolinkResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new MicrolinkResult([]),
        ]);
        [, $err] = MicrolinkMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new MicrolinkSpec(['step' => 's']),
            'response' => new MicrolinkResponse(self::resp(200, ['v' => 1])),
            'result' => new MicrolinkResult([]),
        ]);
        [, $err] = MicrolinkMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new MicrolinkSpec(['step' => 's']),
            'response' => new MicrolinkResponse(self::resp(200, ['v' => 2])),
            'result' => new MicrolinkResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        MicrolinkMakeResponse::call($ctx);
    ...
    {
        $preset = new MicrolinkResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new MicrolinkSpec([]),
            'response' => new MicrolinkResponse([]),
            'result' => new MicrolinkResult([]),
        ...
        [$got, $err] = MicrolinkMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new MicrolinkResult([])]);
        [, $err] = MicrolinkMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new MicrolinkSpec([]), 'result' => null]);
        [, $err] = MicrolinkMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new MicrolinkSpec(['step' => 's']),
            'result' => new MicrolinkResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new MicrolinkOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = MicrolinkMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new MicrolinkSpec(['step' => 's']),
            'result' => new MicrolinkResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new MicrolinkOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = MicrolinkMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new MicrolinkResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new MicrolinkSpec([]),
            'result' => new MicrolinkResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = MicrolinkMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = MicrolinkMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new MicrolinkError('boom', 'boom');
        $utility->fetcher = function (MicrolinkContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new MicrolinkSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = MicrolinkMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (MicrolinkContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = MicrolinkMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(MicrolinkResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (MicrolinkContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new MicrolinkSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = MicrolinkMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new MicrolinkResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new MicrolinkSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = MicrolinkMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = MicrolinkMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = MicrolinkMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new MicrolinkResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, MicrolinkDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new MicrolinkResult(['ok' => false])]);
        $this->expectException(MicrolinkError::class);
        MicrolinkDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new MicrolinkResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', MicrolinkMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        MicrolinkMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new MicrolinkBaseFeature();
        $b = new MicrolinkBaseFeature();
        MicrolinkFeatureAdd::call($ctx, $a);
        MicrolinkFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): MicrolinkBaseFeature
    {
        $f = new MicrolinkBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        MicrolinkFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): MicrolinkContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new MicrolinkSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = MicrolinkPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new MicrolinkResponse(['headers' => null]),
            'result' => new MicrolinkResult([]),
        ]);
        MicrolinkResultHeaders::call($ctx);
