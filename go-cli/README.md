...
AQL-driven CLI and REPL for the Microlink SDK. Positional arguments are
...
./microlink-cli list get_website_data
./microlink-cli load 1 get_website_data
./microlink-cli load '{id:1}' get_website_data
