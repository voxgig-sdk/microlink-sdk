...
class MicrolinkTimeoutFeature extends MicrolinkBaseFeature
{
    ...
    private function _with_timeout(MicrolinkContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(MicrolinkContext $_ctx, float $ms): void
    {
        $client = $this->client;
