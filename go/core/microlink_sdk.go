...
func (sdk *MicrolinkSDK) OptionsMap() map[string]any {
...
func (sdk *MicrolinkSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *MicrolinkSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *MicrolinkSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *MicrolinkSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *MicrolinkSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *MicrolinkSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("MicrolinkSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *MicrolinkSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *MicrolinkSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("MicrolinkSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
