...
describe("GetWebsiteDataDirect", function()
  it("should direct-load-get_website_data", function()
    local setup = get_website_data_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-get_website_data", setup.live and "live" or "unit")
...
function get_website_data_direct_setup(mockres)
