...
from microlink_sdk.microlink_types import (
    GetWebsiteData,
...
class GetWebsiteDataEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GetWebsiteDataEntity(self._client, opts)
    ...
    def data_get(self) -> GetWebsiteData:
    ...
    def match_get(self) -> GetWebsiteData:
    ...
    def load(self, reqmatch=None, ctrl=None) -> GetWebsiteData:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.GetWebsiteData().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
