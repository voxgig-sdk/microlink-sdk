...
class MicrolinkRbacFeature extends MicrolinkBaseFeature
{
    ...
    private function _required(MicrolinkContext $ctx): ?string
    {
    ...
    private function _reject(MicrolinkContext $ctx, string $required): void
    {
    ...
    private function _track(MicrolinkContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
