...
local GetWebsiteDataEntity = {}
GetWebsiteDataEntity.__index = GetWebsiteDataEntity


function GetWebsiteDataEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GetWebsiteDataEntity)
  self._name = "get_website_data"
  self._client = client
...
function GetWebsiteDataEntity:get_name()
  return self._name
end


function GetWebsiteDataEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GetWebsiteDataEntity.new(self._client, opts)
end
...
function GetWebsiteDataEntity:mark_deleted()
  self._deleted = true
end


function GetWebsiteDataEntity:deleted()
  return true == self._deleted
end


function GetWebsiteDataEntity:data_set(args)
  if args ~= nil then
...
function GetWebsiteDataEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GetWebsiteDataEntity:match_set(args)
  if args ~= nil then
...
function GetWebsiteDataEntity:match_get()
...
function GetWebsiteDataEntity:stream(action, args, callopts)
...
function GetWebsiteDataEntity:_run_op(ctx, post_done)
  local utility = self._utility
