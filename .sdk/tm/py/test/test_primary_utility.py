...
from projectname_sdk import MicrolinkSDK
from projectname_sdk.core.spec import MicrolinkSpec
from projectname_sdk.core.result import MicrolinkResult
from projectname_sdk.core.response import MicrolinkResponse
from projectname_sdk.core.operation import MicrolinkOperation
from projectname_sdk.core.error import MicrolinkError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import MicrolinkBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return MicrolinkError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = MicrolinkSDK.test(None, None)
        ...
        class TestInitFeature(MicrolinkBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(MicrolinkBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = MicrolinkSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = MicrolinkSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = MicrolinkSDK.test(None, setup_opts)
