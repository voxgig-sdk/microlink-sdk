...
func registerSDKWords(r *eng.Registry, client *sdk.MicrolinkSDK) {
...
func runOp(client *sdk.MicrolinkSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
