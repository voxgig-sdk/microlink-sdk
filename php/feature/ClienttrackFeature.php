...
// Microlink SDK clienttrack feature
...
class MicrolinkClienttrackFeature extends MicrolinkBaseFeature
{
    ...
    public function PostConstruct(MicrolinkContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Microlink-SDK';
