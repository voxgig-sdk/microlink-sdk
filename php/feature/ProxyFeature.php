...
class MicrolinkProxyFeature extends MicrolinkBaseFeature
{
    ...
    public function init(MicrolinkContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (MicrolinkContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
