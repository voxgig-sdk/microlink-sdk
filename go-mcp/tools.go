...
type Args struct {
	Entity string         `json:"entity" jsonschema:"get_website_data"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.MicrolinkSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "microlink_list",
		Description: "List records from Microlink. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "microlink_load",
		Description: "Load a single record from Microlink. " +
...
func runOp(client *sdk.MicrolinkSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.MicrolinkSDK, name string) (sdk.MicrolinkEntity, error) {
	switch strings.ToLower(name) {
	case "get_website_data":
		return client.GetWebsiteData(nil), nil
