...
// Microlink SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class MicrolinkTestFeature extends MicrolinkBaseFeature
{
    ...
    public function init(MicrolinkContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (MicrolinkContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = MicrolinkParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (MicrolinkContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(MicrolinkContext $ctx, $op, $args): array
    {
