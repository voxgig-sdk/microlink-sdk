...
// Microlink SDK ratelimit feature
...
class MicrolinkRatelimitFeature extends MicrolinkBaseFeature
{
    ...
    private function _acquire(MicrolinkContext $ctx): void
    {
    ...
    private function _track(MicrolinkContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
