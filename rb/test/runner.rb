...
module MicrolinkTestRunner
  ...
  def self.env_override(m)
    live = getenv("MICROLINK_TEST_LIVE")
    override = getenv("MICROLINK_TEST_OVERRIDE")
    ...
    explain = getenv("MICROLINK_TEST_EXPLAIN")
    m["MICROLINK_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = MicrolinkTestRunner
Helpers = MicrolinkHelpers
Vs = VoxgigStruct
