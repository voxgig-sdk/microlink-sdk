...
from microlink_sdk.core.control import MicrolinkControl
...
from microlink_sdk.core.helpers import get_ctx_prop, to_map
...
class MicrolinkContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, MicrolinkSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, MicrolinkResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, MicrolinkResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return MicrolinkError(code, msg, self)
