...
// Microlink SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (MicrolinkSDK::test)
...
{
    private const SDK_CLASS = 'MicrolinkSDK';
    ...
    private const SDK_BASE = 'microlink_sdk';
