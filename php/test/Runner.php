...
class MicrolinkTestRunner
{
    ...
    {
        $live = self::getenv('MICROLINK_TEST_LIVE');
        $override = self::getenv('MICROLINK_TEST_OVERRIDE');
        ...
        $explain = self::getenv('MICROLINK_TEST_EXPLAIN');
...
class_alias('MicrolinkTestRunner', 'Runner');
class_alias('MicrolinkHelpers', 'Helpers');
