...
class MicrolinkTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = MicrolinkTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = MicrolinkTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = MicrolinkTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
