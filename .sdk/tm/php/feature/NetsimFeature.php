...
class MicrolinkNetsimFeature extends MicrolinkBaseFeature
{
    ...
    private function _simulate(MicrolinkContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(MicrolinkContext $ctx, array $applied): void
    {
        $client = $this->client;
