...
// Microlink SDK utility: fetcher

class MicrolinkFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; MicrolinkSDK/1.0)';
    ...
    public static function call(MicrolinkContext $ctx, string $fullurl, array $fetchdef): array
    {
